...
class Product
{
    ...
    #[ORM\Column(name: 'discount_price', type: 'decimal', precision: 10, scale: 2, nullable: true)]
    ...
    public function setDiscountPrice(?string $discountPrice): self { $this->discountPrice = $discountPrice; return $this; }
    ...
    public function setAvgRating(?float $avgRating): self { $this->avgRating = $avgRating; return $this; }
