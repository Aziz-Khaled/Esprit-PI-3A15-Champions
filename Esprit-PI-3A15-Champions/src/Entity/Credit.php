...
class Credit
{
    ...
    #[Assert\NotBlank(message: "Le montant ne peut pas être vide")] // 2. La contrainte
    #[Assert\Positive(message: "Le montant doit être supérieur à zéro")] // 3. La règle métier
